...
async def upload_to_wasabi(file_path: str, filename: str, status_msg: Message) -> str:
    ...
    try:
        ...
        # Run upload in thread with proper error handling
...
async def handle_file(client, message: Message):
    ...
    try:
        upload_url = await upload_to_wasabi(download_path, final_filename, status_msg)
...
# ... (keep the rest of the functions: list_files_command, download_from_wasabi, handle_download_callback the same as before)
